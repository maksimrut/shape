...
import com.rutkouski.shape.parser.impl.ConeParserImpl;
...
public class StringToDoubleParserTest {
	...
	ConeParserImpl stringToDoubleParserImpl;
	
	@BeforeMethod
	public void setUp() {
		stringToDoubleParserImpl = new ConeParserImpl();
	}
	...
	public void parseToDoubleNullPointerExceptionTest() throws ConeException {
		stringToDoubleParserImpl.parseCone(null);
	}

	@Test
	public void parseToDoubleCorrectTest() throws ConeException {
		String actual = stringToDoubleParserImpl.parseCone(listStringCorrect).toString();
	...
	public void parseToDoubleIncorrectTest() throws ConeException {
		String actual = stringToDoubleParserImpl.parseCone(listStringIncorrect).toString();
		String expected = "[]";
 		assertEquals(actual, expected);
	}
}
